...
class LegalRAGWithGroq:
    def __init__(self, base_dir: str = None):
        # Use dynamic path resolution if base_dir not provided
        if base_dir is None:
            script_dir = Path(__file__).resolve().parent
            self.base_dir = script_dir.parent  # Go up to ml directory
        else:
        ...
        project_root = self.base_dir.parent  # Go up to project root
